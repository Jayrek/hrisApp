import 'employees_leave_credits_response.dart';
...
class EmployeeResponse {
  ...
  EmployeeResponse.fromJson(dynamic json) {
    ...
    if (json['leavecredits'] != null) {
      leavecredits = [];
      json['leavecredits'].forEach((v) {
        leavecredits?.add(EmployeesLeaveCreditsResponse.fromJson(v));
      });
    }
  }
  ...
  String? omBmTm;
  String? areaGrouping;
  List<EmployeesLeaveCreditsResponse>? leavecredits;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (leavecredits != null) {
      map['leavecredits'] = leavecredits?.map((v) => v.toJson()).toList();
    }
    return map;
  }
}
